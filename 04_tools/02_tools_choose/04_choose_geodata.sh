choose_geodata() {
    ...
    [ "$GEO_EXISTS_GEODATA_V2RAY" != "installed" ] && has_missing_geodata_bases=true
    ...
    [ "$GEO_EXISTS_GEODATA_V2RAY" = "installed" ] || [ "$GEO_EXISTS_GEODATA_ANTIFILTER" = "installed" ] || [ "$GEO_EXISTS_GEODATA_ANTIZAPRET" = "installed" ] && has_updatable_geodata_bases=true
    ...
    while true; do
        ...
        [ "$GEO_EXISTS_GEODATA_V2RAY" != "installed" ] && v2fly_choice="Установить" || v2fly_choice="Обновить"
        ...
        if [ "$invalid_choice" = false ]; then
            ...
            for choice in $geodata_choices; do
                if [ "$choice" -eq 1 ]; then
                    ...
                    [ "$GEO_EXISTS_GEODATA_V2RAY" != "installed" ] && install_v2fly_geodata=true || update_v2fly_geodata=true
            ...
            # Экспорт переменных
            export chose_geodata_v2fly_select
            export chose_geodata_antifilter_select
            export chose_geodata_antizapret_select
