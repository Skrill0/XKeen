install_geoip() {
    ...
    [ "$install_v2fly_geoip" = true ] && curl -L -o "$GEO_DIR/geoip_v2ray.dat" "https://github.com/Loyalsoldier/v2ray-rules-dat/releases/latest/download/geoip.dat" > /dev/null 2>&1
    ...
    [ "$update_v2fly_geoip" = true ] && [ -f "$GEO_DIR/geoip_v2ray.dat" ] && curl -L -o "$GEO_DIR/geoip_v2ray.dat" "https://github.com/Loyalsoldier/v2ray-rules-dat/releases/latest/download/geoip.dat" > /dev/null 2>&1
}
