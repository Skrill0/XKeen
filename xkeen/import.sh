...
XINFO_DIR="$SCRIPT_DIR/01_info"
XINSTALL_DIR="$SCRIPT_DIR/02_install"
XDELETE_DIR="$SCRIPT_DIR/03_delete"
XTOOLS_DIR="$SCRIPT_DIR/04_tools"
XTESTS_DIR="$SCRIPT_DIR/05_tests"
